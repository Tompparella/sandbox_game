public class Constants
{
    ...
    public const int DEF_REQUIREDACTIONS = 1;
    ...
    public static readonly string IRONDEPOSITDESCRIPTION = "It's a huge mass of stone with rich veins of Iron. An essential resource for any civilization.";
    public static readonly string SILVERDEPOSITDESCRIPTION = "It's a huge mass of stone with clear traces of silver. It's used in almost all vessels that bear magic.";
    public static readonly string EMPTYDEPOSITDESCRIPTION = "It's a huge mass of stone. Any traces of ore have already been exploited";
